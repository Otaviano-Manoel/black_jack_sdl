...
static void Menu_Draw(GameManager *manager)
{
    ...
    // Obj
    obj = Obj_Init();
    obj.InitFull(renderer, &obj, 0, 0, MAX_WIDTH_WINDOW, MAX_HEIGHT_WINDOW, BuildFilePath(manager->assets, "background.bmp"), 0, 0, 0, SDL_TRUE, 255, 0, SDL_FALSE, NULL, NULL, NULL);
    manager->sceneManager->current->AddObj(manager->sceneManager->current, obj);

    // Obj
    obj = Obj_Init();
    obj.InitFull(renderer, &obj, 86, 107, 460, 460, BuildFilePath(manager->assets, "title.bmp"), 0, 0, 0, SDL_TRUE, 255, 1, SDL_FALSE, NULL, NULL, NULL);
    manager->sceneManager->current->AddObj(manager->sceneManager->current, obj);

    // Obj P VS CPU
    obj = Obj_Init();
    obj.InitFull(renderer, &obj, 708, 113, 350, 90, BuildFilePath(manager->assets, "button.bmp"), 0, 0, 0, SDL_TRUE, 255, 1, SDL_TRUE, NULL, NULL, Menu_OnClick_PvsCPU);
    ...
    // Obj P VS P
    obj = Obj_Init();
    obj.InitFull(renderer, &obj, 708, 233, 350, 90, BuildFilePath(manager->assets, "button.bmp"), 0, 0, 0, SDL_TRUE, 255, 1, SDL_TRUE, NULL, NULL, Menu_OnClick_PvsP);
    ...
    // Obj SETTINGS
    obj = Obj_Init();
    obj.InitFull(renderer, &obj, 708, 353, 350, 90, BuildFilePath(manager->assets, "button.bmp"), 0, 0, 0, SDL_TRUE, 255, 1, SDL_TRUE, NULL, NULL, Menu_OnClick_Settings);
    ...
    // Obj QUIT
    obj = Obj_Init();
    obj.InitFull(renderer, &obj, 708, 473, 350, 90, BuildFilePath(manager->assets, "button.bmp"), 0, 0, 0, SDL_TRUE, 255, 1, SDL_TRUE, NULL, NULL, Menu_OnClick_Quit);
