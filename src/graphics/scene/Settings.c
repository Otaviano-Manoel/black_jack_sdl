...
void Setting_Init(GameManager *gameManager)
{
    ...
    obj.Obj_SetImage(renderer, &obj, BuildFilePath(gameManager->assets, "setting.bmp"), MAX_WIDTH_WINDOW, MAX_HEIGHT_WINDOW);
    ...
    obj = Obj_Init();
    obj.layer = 2;
    obj.Obj_ResizeRect(&obj, 450, 162, 451, 397);
    obj.Obj_SetImage(renderer, &obj, BuildFilePath(gameManager->assets, "background_setting.bmp"), 381, 397);
    gameManager->sceneManager->current->AddObj(gameManager->sceneManager->current, obj);

    // Obj
    obj = Obj_Init();
    obj.layer = 2;
    obj.Obj_ResizeRect(&obj, 590, 450, 100, 100);
    obj.Obj_SetImage(renderer, &obj, BuildFilePath(gameManager->assets, "card.bmp"), 100, 100);
    gameManager->sceneManager->current->AddObj(gameManager->sceneManager->current, obj);

    // Obj
    obj = Obj_Init();
    obj.layer = 3;
    obj.Obj_ResizeRect(&obj, 866, 137, 50, 50);
    obj.Obj_SetImage(renderer, &obj, BuildFilePath(gameManager->assets, "close.bmp"), 50, 50);
    RegisterEvent(&obj, NULL, NULL);
    ...
    obj = Obj_Init();
    obj.layer = 3;
    obj.Obj_ResizeRect(&obj, 469, 192, 0, 0);
    obj.Obj_SetImage(renderer, &obj, BuildFilePath(gameManager->assets, "null.bmp"), 50, 50);
    // Text
    ...
    obj = Obj_Init();
    obj.layer = 3;
    obj.Obj_ResizeRect(&obj, 605, 192, 215, 35);
    obj.Obj_SetImage(renderer, &obj, BuildFilePath(gameManager->assets, "b_background.bmp"), 215, 35);
    RegisterEvent(&obj, NULL, NULL);
    obj.isButton = SDL_TRUE;
    // Text
    obj.text->SetFont(obj.text, BuildFilePath(gameManager->assets, "font/MontserratAlternates-Medium.ttf"), 26);
    ...
    obj = Obj_Init();
    obj.layer = 3;
    obj.Obj_ResizeRect(&obj, 469, 252, 0, 0);
    obj.Obj_SetImage(renderer, &obj, BuildFilePath(gameManager->assets, "null.bmp"), 50, 50);
    // Text
    obj.text->SetFont(obj.text, BuildFilePath(gameManager->assets, "font/MontserratAlternates-Medium.ttf"), 26);
    ...
    obj = Obj_Init();
    obj.layer = 3;
    obj.Obj_ResizeRect(&obj, 605, 252, 215, 35);
    obj.Obj_SetImage(renderer, &obj, BuildFilePath(gameManager->assets, "b_background.bmp"), 215, 35);
    RegisterEvent(&obj, NULL, NULL);
    obj.isButton = SDL_TRUE;
    // Text
    ...
    obj = Obj_Init();
    obj.layer = 3;
    obj.Obj_ResizeRect(&obj, 469, 312, 0, 0);
    obj.Obj_SetImage(renderer, &obj, BuildFilePath(gameManager->assets, "null.bmp"), 50, 50);
    // Text
    obj.text->SetFont(obj.text, BuildFilePath(gameManager->assets, "font/MontserratAlternates-Medium.ttf"), 26);
    ...
    obj = Obj_Init();
    obj.layer = 3;
    obj.Obj_ResizeRect(&obj, 605, 312, 275, 35);
    obj.Obj_SetImage(renderer, &obj, BuildFilePath(gameManager->assets, "b_background.bmp"), 215, 35);
    RegisterEvent(&obj, NULL, NULL);
    obj.isButton = SDL_TRUE;
    // Text
    ...
    obj = Obj_Init();
    obj.layer = 3;
    obj.Obj_ResizeRect(&obj, 469, 377, 0, 0);
    obj.Obj_SetImage(renderer, &obj, BuildFilePath(gameManager->assets, "null.bmp"), 50, 50);
    // Text
    obj.text->SetFont(obj.text, BuildFilePath(gameManager->assets, "font/MontserratAlternates-Medium.ttf"), 26);
    ...
    obj = Obj_Init();
    obj.layer = 3;
    obj.Obj_ResizeRect(&obj, 605, 377, 275, 35);
    obj.Obj_SetImage(renderer, &obj, BuildFilePath(gameManager->assets, "b_background.bmp"), 275, 35);
    // Text
    obj.text->SetFont(obj.text, BuildFilePath(gameManager->assets, "font/MontserratAlternates-Medium.ttf"), 17);
    obj.text->SetColor(gameManager, obj.text, "14", (SDL_Color){0, 0, 0, 255});
    obj.text->SetPosition(obj.text, (obj.rect->x + 5), (obj.rect->y + 5));
