...
void Setting_Draw(GameManager *gameManager)
{
    ...
    // Obj
    obj = Obj_Init();
    obj.InitFull(sceneManager, &obj, 0, 0, MAX_WIDTH_WINDOW, MAX_HEIGHT_WINDOW, BuildFilePath(gameManager->assets, "setting.bmp"), 0, 0, 0, SDL_TRUE, 128, 2, SDL_FALSE, NULL, NULL, NULL);
    gameManager->sceneManager->current->AddObj(gameManager->sceneManager->current, obj);

    // Obj
    obj = Obj_Init();
    obj.InitFull(sceneManager, &obj, 450, 162, 451, 450, BuildFilePath(gameManager->assets, "background_setting.bmp"), 0, 0, 0, SDL_TRUE, 255, 2, SDL_FALSE, NULL, NULL, NULL);
    gameManager->sceneManager->current->AddObj(gameManager->sceneManager->current, obj);

    // Obj
    obj = Obj_Init();
    obj.InitFull(sceneManager, &obj, 630, 485, 100, 100, BuildFilePath(gameManager->assets, "card.bmp"), 0, 0, 0, SDL_TRUE, 255, 2, SDL_FALSE, NULL, NULL, NULL);
    gameManager->sceneManager->current->AddObj(gameManager->sceneManager->current, obj);

    // Obj
    obj = Obj_Init();
    obj.InitFull(sceneManager, &obj, 866, 137, 50, 50, BuildFilePath(gameManager->assets, "close.bmp"), 0, 0, 0, SDL_TRUE, 255, 2, SDL_TRUE, NULL, NULL, Setting_OnClick_Quit);
    gameManager->sceneManager->current->AddObj(gameManager->sceneManager->current, obj);

    // Obj Difficulty
    obj = Obj_Init();
    obj.InitFull(sceneManager, &obj, 469, 192, 0, 0, BuildFilePath(gameManager->assets, "null.bmp"), 0, 0, 0, SDL_TRUE, 255, 2, SDL_FALSE, NULL, NULL, NULL);
    ...
    // Obj Difficulty
    obj = Obj_Init();
    obj.InitFull(sceneManager, &obj, 605, 192, 215, 36, BuildFilePath(gameManager->assets, "b_background.bmp"), 0, 0, 0, SDL_TRUE, 255, 2, SDL_TRUE, NULL, NULL, Setting_OnClick_Difficulty);
    ...
    // Obj Style
    obj = Obj_Init();
    obj.InitFull(sceneManager, &obj, 469, 252, 0, 0, BuildFilePath(gameManager->assets, "null.bmp"), 0, 0, 0, SDL_TRUE, 255, 2, SDL_FALSE, NULL, NULL, NULL);
    ...
    // Obj Style
    obj = Obj_Init();
    obj.InitFull(sceneManager, &obj, 605, 252, 215, 35, BuildFilePath(gameManager->assets, "b_background.bmp"), 0, 0, 0, SDL_TRUE, 255, 2, SDL_TRUE, NULL, NULL, Setting_OnClick_Style);
    ...
    // Obj Name P1
    obj = Obj_Init();
    obj.InitFull(sceneManager, &obj, 469, 312, 0, 0, BuildFilePath(gameManager->assets, "null.bmp"), 0, 0, 0, SDL_TRUE, 255, 2, SDL_FALSE, NULL, NULL, NULL);
    ...
    // Obj Name P1
    obj = Obj_Init();
    obj.InitFull(sceneManager, &obj, 605, 312, 275, 35, BuildFilePath(gameManager->assets, "b_background.bmp"), 0, 0, 0, SDL_TRUE, 255, 2, SDL_TRUE, NULL, NULL, Setting_OnClick_SetName_P1);
    ...
    // Obj Name P2
    obj = Obj_Init();
    obj.InitFull(sceneManager, &obj, 469, 377, 0, 0, BuildFilePath(gameManager->assets, "null.bmp"), 0, 0, 0, SDL_TRUE, 255, 2, SDL_FALSE, NULL, NULL, NULL);
    ...
    // Obj Name P2
    obj = Obj_Init();
    obj.InitFull(sceneManager, &obj, 605, 377, 275, 35, BuildFilePath(gameManager->assets, "b_background.bmp"), 0, 0, 0, SDL_TRUE, 255, 2, SDL_TRUE, NULL, NULL, Setting_OnClick_SetName_P2);
    ...
    obj = Obj_Init();
    obj.InitFull(sceneManager, &obj, 469, 435, 0, 0, BuildFilePath(gameManager->assets, "null.bmp"), 0, 0, 0, SDL_TRUE, 255, 2, SDL_FALSE, NULL, NULL, NULL);
