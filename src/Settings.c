...
void Setting_Init(GameManager *gameManager)
{
    ...
    obj.Obj_SetImage(renderer, &obj, GetFile(gameManager, "background_setting.bmp"), 381, 397);
    gameManager->sceneManager->current->AddObj(gameManager->sceneManager->current, obj);
    ...
    obj.Obj_SetImage(renderer, &obj, GetFile(gameManager, "card.bmp"), 100, 100);
    gameManager->sceneManager->current->AddObj(gameManager->sceneManager->current, obj);
    ...
    obj.Obj_SetImage(renderer, &obj, GetFile(gameManager, "close.bmp"), 50, 50);
    RegisterEvent(&obj, NULL, NULL);
    ...
    obj.Obj_SetImage(renderer, &obj, GetFile(gameManager, "null.bmp"), 50, 50);
    // Text
    obj.text->SetFont(obj.text, GetFile(gameManager, "font/MontserratAlternates-Medium.ttf"), 26);
    ...
    obj.Obj_SetImage(renderer, &obj, GetFile(gameManager, "b_background.bmp"), 215, 35);
    RegisterEvent(&obj, NULL, NULL);
    obj.isButton = SDL_TRUE;
    // Text
    obj.text->SetFont(obj.text, GetFile(gameManager, "font/MontserratAlternates-Medium.ttf"), 26);
    ...
    obj.isButton = SDL_TRUE;
    // Text
    obj.text->SetFont(obj.text, GetFile(gameManager, "font/MontserratAlternates-Medium.ttf"), 17);
    ...
    obj.Obj_SetImage(renderer, &obj, GetFile(gameManager, "b_background.bmp"), 275, 35);
    // Text
    obj.text->SetFont(obj.text, GetFile(gameManager, "font/MontserratAlternates-Medium.ttf"), 17);
    obj.text->SetColor(gameManager, obj.text, "14", (SDL_Color){0, 0, 0, 255});
    obj.text->SetPosition(obj.text, (obj.rect->x + 5), (obj.rect->y + 5));
